...
export default Yup.object().shape({
  financial_name: Yup.string().required('Nome obrigatório'),
  ...
  financial_address_number: Yup.number()
  ...
  financial_income_tax: Yup.string()
    .matches(/(true|false)/, () => 'Declaração inválida')
  ...
  supportive_name: Yup.string().required('Nome obrigatório'),
  ...
  supportive_address_number: Yup.number()
    .typeError('Número inválido')
    .required('Número obrigatório'),
